...
class MyGRU:
    ...
    def create_model(self, input_shape):
        ...
        self.model = Sequential()
        self.model.add(GRU(self.hidden_dim, return_sequences=True, input_shape=(self.time_steps, input_shape)))
    ...
    def save(self, folder_path):
        ...
        # Save Keras model
        self.model.save(os.path.join(folder_path, 'gru_model.h5'))
    ...
    def load(cls, folder_path):
        ...
        # Load Keras model
        instance.model = load_model(os.path.join(folder_path, 'gru_model.h5'))
